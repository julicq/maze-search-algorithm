...
class QueueFrontier(StackFrontier):
    def remove(self):
        if self.empty():
            ...
            self.frontier = self.frontier[1:]
            return node
# Maze class has been created to first load the maze from a txt file and validate before explored
class Maze():
    ...
    def solve(self):
        ...
        frontier = QueueFrontier() # Comment to change search method
        # frontier = StackFrontier() # Uncomment to change search method 
        frontier.add(start)
